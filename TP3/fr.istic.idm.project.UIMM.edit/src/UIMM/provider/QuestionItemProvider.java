...
/**
 * This is the item provider adapter for a {@link UIMM.Question} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class QuestionItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 UIMMPackage.Literals.QUESTION__ID,
				 true,
				 false,
				 false,
	...
	protected void addContentPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Question_content_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Question_content_feature", "_UI_Question_type"),
				 UIMMPackage.Literals.QUESTION__CONTENT,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addOptionsPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Question_options_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Question_options_feature", "_UI_Question_type"),
				 UIMMPackage.Literals.QUESTION__OPTIONS,
				 true,
				 false,
				 true,
				 null,
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Question.class)) {
			case UIMMPackage.QUESTION__ID:
			case UIMMPackage.QUESTION__CONTENT:

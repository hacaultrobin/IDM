...
/**
 * This is the item provider adapter for a {@link UIMM.Option} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class OptionItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 UIMMPackage.Literals.OPTION__ID,
				 true,
				 false,
				 false,
	...
	protected void addContentPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Option_content_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Option_content_feature", "_UI_Option_type"),
				 UIMMPackage.Literals.OPTION__CONTENT,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 UIMMPackage.Literals.OPTION__TYPE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Option.class)) {
			case UIMMPackage.OPTION__ID:
			case UIMMPackage.OPTION__CONTENT:
			case UIMMPackage.OPTION__TYPE:

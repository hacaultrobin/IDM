 ...
 * <ul>
 *   <li>{@link fr.istic.idm.project.uIDsl.impl.PollSystemImpl#getPolls <em>Polls</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class PollSystemImpl extends MinimalEObjectImpl.Container implements PollSystem
{
  ...
  {
    return UIDslPackage.Literals.POLL_SYSTEM;
  }
  ...
  public EList<Poll> getPolls()
  {
    if (polls == null)
    {
      polls = new EObjectContainmentEList<Poll>(Poll.class, this, UIDslPackage.POLL_SYSTEM__POLLS);
    }
    return polls;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case UIDslPackage.POLL_SYSTEM__POLLS:

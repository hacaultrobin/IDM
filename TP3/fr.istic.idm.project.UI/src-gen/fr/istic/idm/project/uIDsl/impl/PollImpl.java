 ...
 * <ul>
 *   <li>{@link fr.istic.idm.project.uIDsl.impl.PollImpl#getName <em>Name</em>}</li>
 *   <li>{@link fr.istic.idm.project.uIDsl.impl.PollImpl#getQuestions <em>Questions</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class PollImpl extends MinimalEObjectImpl.Container implements Poll
{
  ...
  {
    return UIDslPackage.Literals.POLL;
  }
  ...
  public void setName(String newName)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, UIDslPackage.POLL__NAME, oldName, name));
  }
  ...
  public EList<Question> getQuestions()
  {
    if (questions == null)
    {
      questions = new EObjectContainmentEList<Question>(Question.class, this, UIDslPackage.POLL__QUESTIONS);
    }
    return questions;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case UIDslPackage.POLL__QUESTIONS:

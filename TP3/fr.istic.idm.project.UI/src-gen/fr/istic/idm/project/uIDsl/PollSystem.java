 ...
 * <ul>
 *   <li>{@link fr.istic.idm.project.uIDsl.PollSystem#getPolls <em>Polls</em>}</li>
 * </ul>
 * </p>
 *
 * @see fr.istic.idm.project.uIDsl.UIDslPackage#getPollSystem()
 * @model
 * @generated
 */
public interface PollSystem extends EObject
{
   ...
   * The list contents are of type {@link fr.istic.idm.project.uIDsl.Poll}.
   * <!-- begin-user-doc -->
   * <p>
   ...
   * @see fr.istic.idm.project.uIDsl.UIDslPackage#getPollSystem_Polls()

 ...
 * <ul>
 *   <li>{@link fr.istic.idm.project.pollDsl.impl.PollImpl#getName <em>Name</em>}</li>
 *   <li>{@link fr.istic.idm.project.pollDsl.impl.PollImpl#getQuestions <em>Questions</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class PollImpl extends MinimalEObjectImpl.Container implements Poll
{
  ...
  {
    return PollDslPackage.Literals.POLL;
  }
  ...
  public void setName(String newName)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, PollDslPackage.POLL__NAME, oldName, name));
  }
  ...
  public EList<Question> getQuestions()
  {
    if (questions == null)
    {
      questions = new EObjectContainmentEList<Question>(Question.class, this, PollDslPackage.POLL__QUESTIONS);
    }
    return questions;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case PollDslPackage.POLL__QUESTIONS:
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case PollDslPackage.POLL__NAME:
        return getName();
      case PollDslPackage.POLL__QUESTIONS:
        return getQuestions();
    }

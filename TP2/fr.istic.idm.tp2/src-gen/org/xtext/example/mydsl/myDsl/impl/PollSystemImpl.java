 ...
 * <ul>
 *   <li>{@link org.xtext.example.mydsl.myDsl.impl.PollSystemImpl#getPolls <em>Polls</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class PollSystemImpl extends MinimalEObjectImpl.Container implements PollSystem
{
  ...
  {
    return MyDslPackage.Literals.POLL_SYSTEM;
  }
  ...
  public EList<Poll> getPolls()
  {
    if (polls == null)
    {
      polls = new EObjectContainmentEList<Poll>(Poll.class, this, MyDslPackage.POLL_SYSTEM__POLLS);
    }
    return polls;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case MyDslPackage.POLL_SYSTEM__POLLS:

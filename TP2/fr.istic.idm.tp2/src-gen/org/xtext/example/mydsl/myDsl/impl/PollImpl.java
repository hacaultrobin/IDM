 ...
 * <ul>
 *   <li>{@link org.xtext.example.mydsl.myDsl.impl.PollImpl#getName <em>Name</em>}</li>
...
public class PollImpl extends MinimalEObjectImpl.Container implements Poll
{
  ...
  public void setName(String newName)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, MyDslPackage.POLL__NAME, oldName, name));
  }
